...
#define STATIC_ASSERT_FLOATING_POINT(Type) static_assert(IS_FLOATING_POINT(Type), "Must be a float")
	...
	static_assert(math::abs(-.1f) == +.1f, "math::abs");
	...
	//static_assert(!equals<float>(+NaN, +NaN),  "math::equals broken");
	//static_assert( equals<float>(+INF, +INF),             "math::equals broken");
	//static_assert(!equals<float>(+INF, -INF),             "math::equals broken");
	static_assert( equals<float>(+1, +1),                   "math::equals broken");
	static_assert( equals<float>(-1, -1),                   "math::equals broken");
	static_assert(!equals<float>(-1, +1),                   "math::equals broken");
	static_assert( equals<float>(+1, +1.000001, 1e-5),      "math::equals broken");
	static_assert(!equals<float>(+1, +1.0001, 1e-5),        "math::equals broken");
	//static_assert( equals<float>(+1000000, +1000001, 1e-5),        "math::equals broken"); // TODO
